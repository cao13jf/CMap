...
def main():
    ...
    train_set = Dataset(root=args.train_data_dir, membrane_names=args.train_embryos, out_class=args.net_params.out_class,for_train=True,
                        transforms=args.train_transforms, return_target=True, args=args)
